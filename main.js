...
global.channelLink = "https://whatsapp.com/channel/0029VbC3eGg2v1IxGUlKY30s";
...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: '𓏲𝐙͢͠꧊ꝛ 𝐄ժı֟፝ẍ ᵌᵌ',
            serverMessageId: -1
        }
    }
};
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029VbC3eGg2v1IxGUlKY30s'
                }, { quoted: message });
                return;
